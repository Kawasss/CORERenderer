...
namespace CORERenderer.OpenGL
{
    ...
    public static unsafe partial class GL
    {
        ...
        /// </summary>
        /// <param name="mode">Specifies how source and destination colors are combined.</param>IntPtr.Zero
        ...
        internal static void GlDrawArrays(int mode, int first, int count) => _glDrawArrays(mode, first, count);
        ...
        internal static void GlDrawElements(int mode, int count, int type, /*const*/ void* indices) => _glDrawElements(mode, count, type, indices);
        ...
        /// <param name="args">Returns the requested object parameter.</param>
        public static void glGetShaderiv(uint shader, int pname, int* args) => _glGetShaderiv(shader, pname, args); //originally , int* args)
        ...
        public static void glBufferData(int target, int size, float[] data, int usage)
        {
            unsafe
            {
                ...
                {
                    IntPtr intptr = new(temp);
                    glBufferData(target, size, intptr, usage);
                }
            }
        }
        ...
        public static void glBufferSubData(int target, int offset, int size, float[] data)
        {
            unsafe
            {
                ...
                {
                    IntPtr intptr = new(temp);
                    glBufferSubData(target, offset, size, intptr);
                }
            }
        }
