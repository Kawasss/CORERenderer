            ...
            try
            {
                ...
                else if (inputs[0] == "save")
                {
                    if (inputs[1] == "scene")
                    {
                        ...
                        Writers.GenerateCRS(COREMain.BaseDirectory, filename, $"Generated by CORE-Renderer {COREMain.VERSION}, CRW {Readers.CURRENT_VERSION} at {DateTime.Now} in {Environment.OSVersion}", COREMain.CurrentScene);
